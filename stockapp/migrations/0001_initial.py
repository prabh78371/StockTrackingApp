# Generated by Django 4.0.2 on 2022-06-29 15:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('barcode_img', models.ImageField(blank=True, upload_to='', verbose_name='images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stockapp.category')),
            ],
        ),
        migrations.AddField(
            model_name='category',
